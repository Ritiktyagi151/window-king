...
export default function VirtualShowroomTour() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1000]  bg-[#090614]/95 text-white">
          ...
          <button
            ...
            aria-label="Close virtual showroom tour"
            className="absolute right-4 top-4 z-20 flex h-11 w-11 items-center justify-center rounded-full bg-white text-[#362A71] shadow-xl transition-colors hover:bg-[#F85A21] hover:text-white sm:right-6 sm:top-6"
          >
            <X size={22} />
          </button>
